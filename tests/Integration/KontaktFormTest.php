...
class KontaktFormTest extends TestCase
{
    ...
    public function testKontaktformularSendetMail(): void
    {
        [$csrf] = $this->fetchCsrf();
        ...
        $msg = $messages[0];
        $this->assertSame('Kontaktformular', $msg['Subject']);
    ...
    {
        $ch = curl_init(self::BASE_URL . '/send_kontakt.php');
        curl_setopt_array($ch, [
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_POST           => true,
            CURLOPT_COOKIEJAR      => self::COOKIE_FILE,
